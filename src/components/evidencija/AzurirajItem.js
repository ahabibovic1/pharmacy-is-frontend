...
export default class AzurirajItem extends Component {
  constructor(props) {
    super(props);
    this.state = {
      supstance: [
      ...
      magistralni: false,
      naziv: this.props.lijek.naziv,
      cijena: this.props.lijek.cijena,
      opis: this.props.lijek.opis,
      nus_pojave: this.props.lijek.nusPojave,
      sastav: this.props.lijek.sastav,
      kontradikcija: this.props.lijek.kontradikcije,
      esencijalni: false,
      show: false,
      alertVisible: false,
      message: "Ažuriranje lijeka je uspješno izvršeno",
      novaSupstanca: false,
      novaSupstancaNaziv: "",
      validated: false,
      kategorija: this.props.lijek.kategorija,
  ...
  DodajLijek() {
    this.setState({ alertVisible: true, message: "Ažuriranje lijeka je uspješno izvršeno" }, () => {
      this.setState({ show: false });
      window.setTimeout(() => {
      ...
      <div>
        ...
        <Form noValidate validated={this.state.validated} onSubmit={this.handleSubmit}>
          <Row>
            <Col xs={6}>
              ...
              <Form.Group>
                ...
                <Form.Control as="select" value={this.state.kategorija} onChange={this.changeKategorija}>
          ...
          <Row className="endButton" style={{ float: "right", marginRight: "70px" }}>
            <Button variant="danger" onClick={this.Nazad} className="button">
              Poništi
            </Button>
        ...
        <Modal show={this.state.show} onHide={this.handleClose}>
          ...
          <Modal.Body>Da li želite ažurirati {this.state.naziv}</Modal.Body>
          <Modal.Footer>
            <Button variant="danger" className="modal-button" onClick={this.handleClose}>
              Ne
            </Button>
            <Button variant="secondary" className="modal-button" onClick={this.DodajLijek}>
              Da
            </Button>
          </Modal.Footer>
        </Modal>
